...
scmu_cc_helper/
├── src/                          # 源代码目录
│   ├── config.js                 # 配置文件 (V1.1.0 更新)
│   ├── course-registration.js    # 核心选课逻辑 (V1.1.0 更新)
│   ├── local-data-manager.js     # 本地数据管理器 (V1.1.0 更新)
│   └── ui-controller.js          # 用户界面控制 (V1.1.0 更新)
├── docs/                         # 文档目录
│   ├── installation-guide.md     # 详细安装教程
│   ├── api-reference.md          # API参考文档
│   ├── troubleshooting.md        # 故障排除
│   ├── v1.1.0-release-notes.md   # V1.1.0发布说明 (新增)
│   ├── course-types-guide.md     # 课程类型使用指南 (新增)
│   └── migration-guide.md        # 版本迁移指南 (新增)
├── examples/                     # 示例代码
│   └── usage-examples.js         # 使用示例
├── dist/                         # 发布文件 (V1.1.0)
│   ├── course-helper.js          # 单文件版本 (V1.1.0)
│   └── tampermonkey-course-helper.js  # 油猴脚本版本 (V1.1.0)
└── README.md                     # 项目说明文档
```
